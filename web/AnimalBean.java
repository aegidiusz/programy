...
public class AnimalBean implements Serializable {
    ...
    private AnimalListDTO animalListDTO = new AnimalListDTO(animalList);

    public AnimalListDTO getAnimalListDTO() {
        return animalListDTO;
    }

    public void setAnimalListDTO(AnimalListDTO animalListDTO) {
        this.animalListDTO = animalListDTO;
    }
    ...
    public String listAllAnimal() {
        animalEndpoint.listAllAnimal(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllCats() {
        animalEndpoint.listAllCats(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllDogs() {
        animalEndpoint.listAllDogs(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllGuineaPigs() {
        animalEndpoint.listAllGuineaPigs(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllRabbits() {
        animalEndpoint.listAllRabbits(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllOtherAnimals() {
        animalEndpoint.listAllOtherAnimal(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllBoys() {
        animalEndpoint.listAllBoys(animalListDTO);
        return "/listAnimal.xhtml";
    }

    public String listAllGirls() {
        animalEndpoint.listAllGirls(animalListDTO);
        return "/listAnimal.xhtml";
    }
